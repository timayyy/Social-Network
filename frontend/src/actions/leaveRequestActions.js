...
export const deleteLeaveRequest = (id) => async (dispatch, getState) => {
    try {
        dispatch({
            type: LEAVE_REQUEST_DELETE_REQUEST,
        });
        ...
        await axios.delete(`/api/leaverequest/${id}`, config);
